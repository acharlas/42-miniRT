...
/*   Updated: 2020/02/03 14:51:45 by rdeban           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (obj->type == 't')
		return (ray_intersect_triangle(ray.orig, ray.dir, t0, *TRIANGLE));
	else if (obj->type == 's')
		return (ray_intersect_sphere(ray.orig, ray.dir, t0, *SPHERE));
	else if (obj->type == 'p')
		return (ray_intersect_plane(ray.orig, ray.dir, t0, *PLANE));
	else if (obj->type == 'c')
		return (ray_intersect_cylinder(ray.orig, ray.dir, t0, *CYLINDER));
	else if (obj->type == 'k')
		return (ray_intersect_cone(ray.orig, ray.dir, t0, *CONE));
	else
		return (0.);
}
